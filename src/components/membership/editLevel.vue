  ...
  <div class="editLevel">
    ...
    <el-main>
      <el-form
        ...
        label-position="top"
      >
        <el-form-item label="会员等级名称:(中文)"  prop="memberLevelName">
          <el-input
        ...
        <el-form-item label="会员等级名称:(英文)"  prop="memberLevelNameEn">
          <el-input
            placeholder="请输入大于0的整数"
            show-word-limit
            maxlength="50"
        ...
        <el-form-item label="会员积分" prop="memberLevelIntegral">
          <el-input
            ...
            maxlength="50"
            clearable
            v-model.number="ruleForm.memberLevelIntegral"
          ></el-input>
        </el-form-item>
        ...
        <el-form-item label="总共可推荐项目次数" prop="memberRecommendCount">
          <el-input
            ...
            v-model.number="ruleForm.memberRecommendCount"
          ></el-input>
        </el-form-item>
        <el-form-item
          label="优先推荐中间人时间（月）"
        ...
        >
          <el-input
            ...
            clearable
            oninput="value=value.replace(/[^\d]/g,'')"
            v-model.number="ruleForm.recommendMiddlemanTime"
          ></el-input>
        </el-form-item>
        <el-form-item
          label="优先推荐投资人时间（月）"
        ...
        >
          <el-input
            ...
            clearable
            oninput="value=value.replace(/[^\d]/g,'')"
            v-model.number="ruleForm.recommendInvestorTime"
          ></el-input>
        </el-form-item>
        ...
        <el-form-item label="保级积分值" prop="relegationIntegralValue">
          <el-input
            ...
            clearable
            oninput="value=value.replace(/[^\d]/g,'')"
            v-model.number="ruleForm.relegationIntegralValue"
          ></el-input>
        </el-form-item>
      </el-form>
...
export default {
  ...
  methods: {
          ...
          if (res.data.resultCode === 10000) {
            ...
            for (var key in tableData.bslMemberSystem) {
              for (var name in this.ruleForm) {
                if (key === name) {
                  if (key === 'memberTime') {
                    this.ruleForm[name] = tableData.bslMemberSystem[key] * 1000
                  } else {
    ...
    add_industry () {
      console.log(this.ruleForm)
      let obj = this.$global.deepCopy(this.ruleForm)
      if (obj.memberTime.toString().toString().length === 10) {
      } else if (obj.memberTime.toString().toString().length === 13) {
        obj.memberTime = obj.memberTime / 1000
      }
      let self = this
      this.$global
