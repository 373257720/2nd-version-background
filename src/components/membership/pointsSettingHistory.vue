  ...
  <div class="contractItem">
    <el-main>
      ...
      <el-table
        ...
        border
      >
        <el-table-column width="200" prop="idx" label="设置时间" align="center"></el-table-column>
        <el-table-column prop="industryNameEn" show-overflow-tooltip label="规则名称" align="center"></el-table-column>
        ...
        <el-table-column prop="industryNameEn" show-overflow-tooltip label="宣传内容" align="center"></el-table-column>
        <el-table-column prop="industryNameEn" show-overflow-tooltip label="时限" align="center"></el-table-column>
        <el-table-column prop="industryNameEn" show-overflow-tooltip label="是否公开" align="center"></el-table-column>
        <el-table-column fixed="right" label="操作" width="200" align="center">
          <template slot-scope="scope">
            <el-button  type="text" size="small"    @click="$routerto('')">编辑</el-button>
